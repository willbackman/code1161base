...
be_cool_for_ever("Will", "will_is_cool.txt")
be_cool_for_ever("Will", "week4/will_is_cool.lol_UR_joking")
be_cool_for_ever("Will", "../will_is_cool.periscope")
